...
restart.scale=0.3
  ...
  bgg=createSprite(278,160)
  bgg.addImage(winbgimg)
  bgg.scale=1
  bgg.visible=false


  bgg3=createSprite(1450,610)
  bgg3.addImage(winbgimg)
  bgg3.scale=3
  bgg3.visible=false

  bgg1=createSprite(600,160)
  bgg1.addImage(winbgimg)
  bgg1.scale=1
  bgg1.visible=false

  bgg2=createSprite(1150,160)
  bgg2.addImage(winbgimg)
  bgg2.scale=1
  bgg2.visible=false

  bgg4=createSprite(92,480)
  bgg4.addImage(winbgimg)
  bgg4.scale=1.1
  bgg4.visible=false

  bgg5=createSprite(565,585)
  bgg5.addImage(winbgimg)
  bgg5.scale=0.6
  bgg5.visible=false

  bgg6=createSprite(690,395)
  bgg6.addImage(winbgimg)
  bgg6.scale=0.6
  bgg6.visible=false

  bgg7=createSprite(450,345)
  bgg7.addImage(winbgimg)
  bgg7.scale=0.3
  bgg7.visible=false

  endingbg1=createSprite(950,320)
  endingbg1.addImage(endingbg)
  endingbg1.scale=3.5
  endingbg1.visible=false
}
...
if(life==0){
  ...
  gameoversound.play()
  endingbg1.visible=true
  
  textSize(20)
  fill("green")
  stroke("black")
  text("OH !! NO YOU LOSE",100,300);
  text("PRESS RESTART BUTTON TO RESTART",100,330);
